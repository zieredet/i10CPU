...
namespace ch.zhaw.HenselerGroup.CPU.Impl.Memory
{
    ...
    public class MemoryBasic : IMemory
    {
        ...
        public IWord GetWord(int address)
        {
        ...
        public void SetWord(int address, IWord word) { SetWord(address, word.UValue); }
        ...
        #region IEnumerable<Word> Implementierung
